...
NORTH_LINE = [Point(45000, 0, 8500), Point(25000, -50000, 8500), Point(-25000, 55000, 8500), Point(-45000, 55000, 8500)]
# 南部航线干扰
            ...
            for ship in obs_red['units']:
                if ship['LX'] == 21:
                    if index == 1:
                        ...
                        x = [model.add_var(var_type=CONTINUOUS) for i in range(2)]  # 决策变量

                        model += xsum(x[i] * c[i] for i in range(len(c)))  # 目标函数
