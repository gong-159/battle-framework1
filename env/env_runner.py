...
class EnvRunner(object):
    ...
    def _get_actions_red(self):
        return action_list_red

    def _get_actions_blue(self):
        return action_list_blue
    ...
    def _run_agents(self, observation):
        global action_list_blue
        global action_list_red
